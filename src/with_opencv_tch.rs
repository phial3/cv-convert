...
//             Ok(Mat::new_rows_cols_with_data(rows, cols, data_slice)?.try_into()?)
//         }
//
//         // 计算总数据量
...
//         let mat = unsafe {
//             match tensor.kind() {
//                 tch::Kind::Uint8 => create_mat_from_tensor::<u8>(&tensor, total_size, rows as i32, cols as i32)?,
//                 tch::Kind::Int8 => create_mat_from_tensor::<i8>(&tensor, total_size, rows as i32, cols as i32)?,
//                 tch::Kind::Int16 => create_mat_from_tensor::<i16>(&tensor, total_size, rows as i32, cols as i32)?,
//                 tch::Kind::Float => create_mat_from_tensor::<f32>(&tensor, total_size, rows as i32, cols as i32)?,
//                 tch::Kind::Double => create_mat_from_tensor::<f64>(&tensor, total_size, rows as i32, cols as i32)?,
